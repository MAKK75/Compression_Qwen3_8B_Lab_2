...
Цель: Сжать модель **Qwen3-8B** и замерить качество на бенчмарке **MMLU**.
...
Скрипт скачивает сжатую модель, запускает MMLU бенчмарк (20% выборки для ускорения) и считает Score.
